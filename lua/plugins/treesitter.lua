...
-- auto install missing parsers for rust jas, lua, etc.
...
for _, map in ipairs({
  { { "n", "x", "o" }, "]m", mv.goto_next_start,    "@function.inner" },
...
-- Enable nvims native treesitter syntax highlighting auto
...
-- Enable treesitter-based code folding (optional)
vim.api.nvim_create_autocmd("FileType", {
  group = vim.api.nvim_create_augroup("user_treesitter_folding", { clear = true }),
  callback = function()
